                            ...
                            <div class="card-body p-3 p-md-4 p-xl-5">
                                ...
                                <form action="{{ route('account.processregister') }}" method="POST">
                                    ...
                                    <div class="row gy-3 overflow-hidden">
                                        ...
                                        <div class="col-12">
                                            <div class="form-floating mb-3">
                                                <input type="tel" value="{{ old('number') }}" class="form-control @error('number') is-invalid @enderror" name="number" id="number" placeholder="Your phone number">
                                        ...
                                        <div class="col-12">
                                            <div class="form-floating mb-3">
                                                <input type="text" value="{{ old('address') }}" class="form-control @error('address') is-invalid @enderror" name="address" id="address" placeholder="Your address">
